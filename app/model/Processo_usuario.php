...
$cidade = filter_input(INPUT_POST, 'cidade', FILTER_SANITIZE_STRING); 
    ...
    //Renomeiar
        $_UP['renomeia'] = false; // pesquisa esse eroo no google 
        ...
        if($_FILES['arquivo']['error'] != 0){ // aqui tbm viu 
        ...
        //O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
            ...
            if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta']. $nome_final)){// nada n kkk
                //Upload efetuado com sucesso, exibe a mensagem
                //inserindo dados no banco
                $result_usuario = "insert into usuario (nome,celular,email,senha,cidade,cep,caminho_foto) values ('$nome','$celular','$email','$senha','$cidade','$cep','$nome_final')";
