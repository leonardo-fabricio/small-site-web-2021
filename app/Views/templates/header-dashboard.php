...
<body>
    ...
    <header>
        ...
        <b><h4 id="msg-dashboard">Olá, @Usuário! Administre seus anuncios, solicitações e muito mais.</h4></b>
        <br>    
        <ul id="slide-out" class="sidenav">
            ...
            <a href="#name"><span class="white-text name">Luis Lucilandio</span></a>
            <a href="#email"><span class="white-text email">L@gmail.com</span></a>
            </div></li>
